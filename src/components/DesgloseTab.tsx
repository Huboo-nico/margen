        ...
        <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-bold text-gray-900">
                  {language === 'en'
                    ? 'Net Profit Contribution by Line (€)'
                    : 'Aportación al Beneficio Neto por Línea (€)'}
                </h3>
              </div>
            ...
            <p className="text-xs text-gray-500 mb-4">
              {language === 'en'
                ? 'Absolute profit in Euros (€) generated by each operational service.'
                : 'Beneficio absoluto en Euros (€) generado por cada servicio operativo.'}
            </p>
          ...
          <div className="pt-3 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
            <span className="flex items-center gap-1.5">
              ...
              {language === 'en' ? 'Positive Margin (€)' : 'Margen positivo (€)'}
            </span>
            <span className="flex items-center gap-1.5">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs text-gray-500">
            {language === 'en' ? 'Direct comparison in Euros (€)' : 'Comparativa directa en Euros (€)'}
          </span>
        </div>
